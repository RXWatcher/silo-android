...
fun DownloadSidecar.toEntity(serverId: String, profileId: String): DownloadEntity =
    DownloadEntity(
        ...
        audiobookPartCount = audiobookPartCount,
        audiobookPartIndex = audiobookPartIndex,
        audiobookPartDurationSeconds = audiobookPartDurationSeconds,
        audiobookPartStartOffsetSeconds = audiobookPartStartOffsetSeconds,
        audiobookTotalSeconds = audiobookTotalSeconds,
