...
class Media3VideoPlaybackBackend(
    ...
    override fun selectSubtitle(track: VideoPlayerTrackEntry?): Boolean {
        ...
        // throw, crashing the app when a same-route retry asked for a subtitle
        // before the remount had happened; the caller already treats false as
        // "not selected" and retries once tracks publish.
